...
public class LeaderboardActivity extends AppCompatActivity {
    ...
    private PassedScoreViewModel mPassedScoreViewModel;
...
//        mWordViewModel = ViewModelProviders.of(this).get(WordViewModel.class);
        mPassedScoreViewModel = ViewModelProviders.of(this).get(PassedScoreViewModel.class);
...
//            }
//        });
        mPassedScoreViewModel.getmAllPassedScores().observe(this, new Observer<List<PassedScore>>() {
            @Override
